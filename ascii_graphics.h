#ifndef _ASCIIGRAPHICS_H_
#define _ASCIIGRAPHICS_H_
#include <vector>
#include <string>
...
// Returns a vector of strings to display a simple minion with no abilities
card_template_t display_minion_no_ability(std::string name,int cost,int attack,int defence);

// Returns a vector of strings to display a minion with a triggered ability
card_template_t display_minion_triggered_ability(std::string name,int cost,int attack,int defence,
                                                 std::string trigger_desc);

// Returns a vector of strings to display a minion with an activated ability
...
// Returns a vector of strings to display a ritual
card_template_t display_ritual(std::string name,int cost,int ritual_cost,std::string ritual_desc,
                               int ritual_charges);

// Returns a vector of strings to display a spell
card_template_t display_spell(std::string name,int cost,std::string desc);

// Returns a vector of strings to display an enchantment with values for attack and defence
...
// Returns a vector of strings to display a simple enchantment
card_template_t display_enchantment(std::string name,int cost,std::string desc);

// Returns a vector of strings to display the player information
// Note: player_num must be 1 or 2
